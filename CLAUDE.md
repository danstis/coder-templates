...
- **plugin_agent_os**: Installs [Agent OS](https://buildermethods.com/agent-os) standards system for keeping AI agents aligned with project conventions (default: disabled)
